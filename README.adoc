...
= Sistema Bancário para Testes com JUnit 5    image:https://img.shields.io/github/workflow/status/ProgramadorGenuino/Sistema_Bancario/maven[GitHub Workflow Status]
...
====
Relatório - Cobertura de código (JaCoCo).
