...
public class Conta implements Cadastro {
    ...
    public void setNumero(String numero) {
        Objects.requireNonNull(numero, "O parâmetro numero deste método não dode ser nulo");
        
        if(!numero.matches("\\d{5}-\\d{1}")){
            throw new IllegalArgumentException("Número de conta inválido! formato esperado... 99999-9");
        }
        this.numero = numero;
    }
